...
export const menuBasicTables: MenuItem[] = [
  {
    title: gamblingFeatureTitle.label.plural,
    url: gamblingFeatureTitle.href,
  ...
  {
    title: buildingPassiveTitle.label.plural,
    url: buildingPassiveTitle.href,
    icon: BuildingPassiveIcon,
  },
  {
    title: buildingPassiveDurationTitle.label.plural,
    url: buildingPassiveDurationTitle.href,
