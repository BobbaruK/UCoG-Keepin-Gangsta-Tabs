    ...
    <>
      <ResponsiveDialog
        ...
        header={{
          ...
          description: `This action cannot be undone. This will permanently delete this ${captainRolesTitle.label.singular.toLowerCase()} and remove it's data from our servers.`,
        }}
      >
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem onClick={handleCopy(captainRole.id)}>
            <CopyIcon /> Copy ID
          </DropdownMenuItem>
          ...
          {session && session.user.role !== UserRole.USER && (
            <>
              <DropdownMenuSeparator />
              <DropdownMenuItem asChild>
                <Link href={`${captainRolesTitle.href}/${captainRole.id}/edit`}>
                  <EditIcon />
                  Edit {captainRolesTitle.label.singular.toLowerCase()}
                </Link>
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem
              ...
              >
                <TrashIcon />
                Delete {captainRolesTitle.label.singular.toLowerCase()}
              </DropdownMenuItem>
            </>
          )}
        </DropdownMenuContent>
