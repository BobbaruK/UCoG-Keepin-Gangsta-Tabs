    ...
    <>
      <ResponsiveDialog
        ...
        header={{
          ...
          description: `This action cannot be undone. This will permanently delete selected ${crewMembersTitle.label.singular.toLowerCase()}(s) and remove it's data from our servers.`,
        }}
      >
