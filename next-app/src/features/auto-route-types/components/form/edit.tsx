...
import { editAutoRouteType } from "../../actions/edit";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-end gap-4">
        ...
        <CustomButton
          buttonLabel={`Save ${autoRouteTypesTitle.label.singular.toLowerCase()}`}
          type="submit"
          className=""
          disabled={isPending}
...
export default EditAutoRouteTypeForm;

export function EditAutoRouteTypeFormSkeleton({
  className,
  ...restProps
  ...
  return (
    <div className={cn("space-y-7", className)} {...restProps}>
      ...
      <div className="flex flex-wrap items-center justify-end gap-4">
        ...
        <Skeleton className="bg-success h-9 w-[164px]" />
      </div>
    </div>
  );
}
