    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem onClick={handleCopy(buildingSize.id)}>
            <CopyIcon /> Copy ID
          </DropdownMenuItem>

          <DropdownMenuItem asChild>
            <Link href={`${buildingSizesTitle.href}/${buildingSize.id}`}>
              <BuildingSizeIcon />
              Go to {buildingSizesTitle.label.singular.toLowerCase()}
            </Link>
          </DropdownMenuItem>
          ...
          {session && session.user.role !== UserRole.USER && (
            <>
              ...
              <DropdownMenuItem asChild>
                <Link
                  href={`${buildingSizesTitle.href}/${buildingSize.id}/edit`}
                >
                  <EditIcon />
                  Edit {buildingSizesTitle.label.singular.toLowerCase()}
                </Link>
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem
              ...
              >
                <TrashIcon />
                Delete {buildingSizesTitle.label.singular.toLowerCase()}
              </DropdownMenuItem>
            </>
          )}
        </DropdownMenuContent>
