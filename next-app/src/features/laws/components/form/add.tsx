...
import { cog_side_effect, LawType } from "@/generated/prisma";
...
import z from "zod";
import { addLaw } from "../../actions/add";
...
const AddLawForm = ({ sideEffects }: Props) => {
  ...
  const { formId, inputId } = formInputId(
    `add-${lawsTitle.label.singular.toLowerCase()}-form`,
  );
