    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem onClick={handleCopy(buildingBackroom.id)}>
            <CopyIcon /> Copy ID
          </DropdownMenuItem>
          ...
          <DropdownMenuItem asChild>
            ...
            >
              <BuildingBackroomIcon />
              Go to {buildingBackroomsTitle.label.singular.toLowerCase()}
            </Link>
          </DropdownMenuItem>
          ...
          {session && session.user.role !== UserRole.USER && (
            <>
              ...
              <DropdownMenuItem asChild>
                <Link
                  href={`${buildingBackroomsTitle.href}/${buildingBackroom.id}/edit`}
                >
                  <EditIcon />
                  Edit {buildingBackroomsTitle.label.singular.toLowerCase()}
                </Link>
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem
              ...
              >
                <TrashIcon />
                Delete {buildingBackroomsTitle.label.singular.toLowerCase()}
              </DropdownMenuItem>
            </>
          )}
        </DropdownMenuContent>
